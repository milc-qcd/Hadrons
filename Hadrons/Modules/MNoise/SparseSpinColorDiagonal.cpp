/*
 * SparseSpinColorDiagonal.cpp, part of Hadrons (https://github.com/aportelli/Hadrons)
 *
...
template class HADRONS_NAMESPACE::MNoise::TSparseSpinColorDiagonal<STAGIMPL>;
