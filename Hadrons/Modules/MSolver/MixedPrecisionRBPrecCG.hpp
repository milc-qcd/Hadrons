/*
 * MixedPrecisionRBPrecCG.hpp, part of Hadrons
...
public:
  GRID_SERIALIZABLE_CLASS_MEMBERS(MixedPrecisionRBPrecCGPar, std::string,
...
MODULE_REGISTER_TMP(StagMixedPrecisionRBPrecCG,
                    ARG(TMixedPrecisionRBPrecCG<STAGIMPLF, STAGIMPLD>),
                    MSolver);
...
// constructor /////////////////////////////////////////////////////////////////
template <typename FImplInner, typename FImplOuter>
TMixedPrecisionRBPrecCG<FImplInner, FImplOuter>::TMixedPrecisionRBPrecCG(
...
TMixedPrecisionRBPrecCG<FImplInner, FImplOuter>::getInput(void) {
...
template <typename FImplInner, typename FImplOuter>
std::vector<std::string>
TMixedPrecisionRBPrecCG<FImplInner, FImplOuter>::getOutput(void) {
...
template <typename FImplInner, typename FImplOuter>
DependencyMap
TMixedPrecisionRBPrecCG<FImplInner, FImplOuter>::getObjectDependencies(void) {
  DependencyMap dep;
...
#define SOLVER_BODY                                                            \
  ...
  MixedPrecisionConjugateGradient<FermionFieldOuter, FermionFieldInner> mpcg(  \
      ...
      getGrid<FermionFieldInner>(true, Ls), simat, somat);                     \
...
void TMixedPrecisionRBPrecCG<FImplInner, FImplOuter>::setup(void) {
  ...
  auto makeVecSolver = [&imat, &omat, iguesserPt, oguesserPt, Ls,
                        this](bool subGuess) {
    return [&imat, &omat, iguesserPt, oguesserPt, subGuess, Ls, this](
               std::vector<FermionFieldOuter> &sol,
               const std::vector<FermionFieldOuter> &source) { SOLVER_BODY; };
  };
